                ...
                @foreach ($listados as $listado)
                    <tr>
                        <td class="v-align-middle">
                          <p>{{ $listado->matricula }}</p>
                        </td>
                        <td class="v-align-middle">
                          <p>{{ $listado->nombreCompleto() }}</p>
                        </td>
                        <td class="v-align-middle">
                          <p>{!! $listado->Activo() !!}</p>
                        </td>
                        <td class="v-align-middle">
                                <div class="dropdown dropdown-default">
                                    ...
                                    <div class="dropdown-menu">
                                      <a class="dropdown-item" href="{{ route("alumnoEdit",['id' => $listado->id]) }}"><i class="pg-icon">edit</i>  Editar</a>
                                      <a class="dropdown-item" href="{{ route("alumnoDetail",['id' => $listado->id]) }}"><i class="pg-icon">text_align_justify</i>  Detalles</a>
                                    </div>
                                </div>
                        </td>
                      </tr>
