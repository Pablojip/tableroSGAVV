...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Buscar bitacora de registros.
            </div>
          </div>
          <div class="card-body loadingContent">
              ...
              <div class="row clearfix">
                <div class="col-xl-4">
                    <div class="form-group form-group-default">
                       {{  Form::label('Modulo') }}
                        <input type="text" class="form-control" name="modulo"  placeholder="nombre del modulo">
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="form-group form-group-default">
                        {{  Form::label('Fecha inicio') }}
                        <input type="text" class="form-control datepicker" id="datepicker-component2" name="fecha_inicio" placeholder="Seleccione fecha">
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="form-group form-group-default">
                        {{  Form::label('Fecha de termino') }}
                        <input type="text" class="form-control" id="datepicker-component2" name="fecha_fin" placeholder="Seleccione fecha">
                    </div>
                </div>
              </div>
              <div class="row clearfix">
            ...
            <hr>
            <div id="lista">
                    @include('bitacora._list')
            </div>
            <div id="modal">
                @include('bitacora._modal')
        </div>
        ...
        //limpiar
         ...
         $('#form-create').submit(function (e){
            e.preventDefault();
                try{
                    showLoading();
                    $.get('{{ route("bitacoraIndex") }}',$(this).serialize())
                    .done(function(data) {
                    if(data.valido){
            ...
            $(document).on('click','.pagination a',function(event){
                ...
                fetch_data('{{ route("bitacoraIndex") }}?page='+pagina,form);
            });
