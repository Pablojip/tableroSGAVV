...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Buscar ciclo escolar.
            </div>
          </div>
          <div class="card-body">
            <h2 class="mw-80">Ciclo Escolar</h2>
              ...
              <div class="row clearfix loadingContent">
                <div class="col-xl-4">
                  <div class="form-group form-group-default">
                    {{  Form::label('inicio') }}
                    <input type="text" class="form-control" name="inicio"  placeholder="inicio del ciclo escolar">
                  </div>
                </div>
                <div class="col-xl-4">
                    <div class="form-group form-group-default">
                        {{  Form::label('Fin') }}
                        <input type="text" class="form-control" name="fin" placeholder="fin del ciclo escolar">
                    </div>
                </div>
              </div>
        ...
        //limpiar
         ...
         $('#form-create').submit(function (e){
            e.preventDefault();
                try{
                    showLoading();
                    $.get('{{ route("cicloEscolarIndex") }}',$(this).serialize())
                    .done(function(data) {
                        console.log(data);
                    if(data.valido){
            ...
            $(document).on('click','.pagination a',function(event){
                ...
                fetch_data('{{ route("cicloEscolarIndex") }}?page='+pagina,form);
            });
