...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Creación de grado.
            </div>
          </div>
          <div class="card-body">
            <h2 class="mw-80">Nuevo grado</h2>
              ...
              <div class="row clearfix loadingContent">
                <div class="col-xl-4">
                  <div class="form-group form-group-default required">
                    {{  Form::label('Grado') }}
                    <input type="text" class="form-control" name="grado" required  placeholder="Grado">
                  </div>
                </div>
              </div>
        ...
        //limpiar
         $('#form-create').submit(function (e){
            ...
            if(valido){    
                try{
                    showLoading();
                    $.post('{{ route("gradoStore") }}',$(this).serialize())
                    .done(function(data) {
                        if(data.valido){
                            limpiar();
                            alert(data.mensaje);
