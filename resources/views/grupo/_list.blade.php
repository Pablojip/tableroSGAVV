                        ...
                        <td class="v-align-middle">
                                <div class="dropdown dropdown-default">
                                    ...
                                    <div class="dropdown-menu">
                                      <a class="dropdown-item" href="{{ route("grupoEdit",['id' => $listado->id]) }}"><i class="pg-icon">edit</i>  Editar</a>
                                      <a class="dropdown-item" href="{{ route("grupoDetail",['id' => $listado->id]) }}"><i class="pg-icon">text_align_justify</i>  Detalles</a>
                                    </div>
                                </div>
                        </td>
                      </tr>
