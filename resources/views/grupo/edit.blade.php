...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Editar grupo.
            </div>
          </div>
          <div class="card-body">
              ...
              <div class="row clearfix loadingContent">
                <div class="col-xl-4">
                  <div class="form-group form-group-default required">
                    {{  Form::label('Grupo') }}
                  <input type="text" class="form-control" name="grupo" required  placeholder="Grupo" value="{{ $model->grupo }}">
                  </div>
                </div>
                <div class="col-md-1">
        ...
        //limpiar
         $('#form-edit').submit(function (e){
            ...
            if(valido){    
                try{
                    showLoading();
                    $.post('{{ route("grupoUpdate") }}',$(this).serialize())
                    .done(function(data) {
                        if(data.valido){
                            alert(data.mensaje);
                        }else{
