...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Creación de maestro.
            </div>
          </div>
          <div class="card-body loadingContent">
            <h2 class="mw-80">Nuevo maestro</h2>
                ...
                <div class="row clearfix">
                    <div class="col-xl-4">
                        <div class="form-group form-group-default required">
                              {{  Form::label('Clave') }}
                              <input type="text" class="form-control" name="clave" required  placeholder="clavel del maestro">
                        </div>
                    </div>
                </div>
              <div class="row clearfix">
        ...
        //limpiar
         $('#form-create').submit(function (e){
            ...
            if(valido){    
                try{
                    showLoading();
                    $.post('{{ route("maestroStore") }}',$(this).serialize())
                    .done(function(data) {
                        if(data.valido){
                            limpiar();
                            alert(data.mensaje);
