...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Detalle del maestro.
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row clearfix loadingContent">
              ...
              <div class="row m-t-25">
                ...
                <div class="col-xl-2">
                    <a href="{{ route("maestroEdit",['id' => $model->id]) }}" aria-label="" class="btn btn-warning pull-right btn-lg btn-block" type="submit">
                        Editar
                    </a>
                </div>
              </div>
