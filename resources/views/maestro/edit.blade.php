...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Editar maestro.
            </div>
          </div>
            ...
            <div class="row clearfix">
                <div class="col-xl-4">
                  <div class="form-group form-group-default required">
                        {{  Form::label('Clave') }}
                      <input type="text" class="form-control" name="clave" required  placeholder="clave del maestro" value="{{ $model->clave }}">
                  </div>
                </div>
            </div>
              <div class="row clearfix">
              ...
              <div class="row m-t-25">
                ...
                <div class="col-xl-2">
                    <a href="{{ route("maestroIndex") }}" aria-label="" class="btn btn-secondary pull-right btn-lg btn-block" type="button">
                        consulta
                    </a>
                </div>
                <div class="col-xl-2">
        ...
        //limpiar
         $('#form-edit').submit(function (e){
            ...
            if(valido){    
                try{
                    showLoading();
                    $.post('{{ route("maestroUpdate") }}',$(this).serialize())
                    .done(function(data) {
                        if(data.valido){
                            alert(data.mensaje);
                        }else{
