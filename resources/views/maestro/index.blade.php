...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Buscar maestros.
            </div>
          </div>
              ...
              <div class="row clearfix">
                <div class="col-xl-4">
                    <div class="form-group form-group-default">
                       {{  Form::label('Clave') }}
                        <input type="text" class="form-control" name="clave"  placeholder="clave del maestro">
                    </div>
                </div>
                <div class="col-xl-4">
                  <div class="form-group form-group-default">
        ...
        //limpiar
         ...
         $('#form-create').submit(function (e){
            e.preventDefault();
                try{
                    showLoading();
                    $.get('{{ route("maestroIndex") }}',$(this).serialize())
                    .done(function(data) {
                        console.log(data);
                    if(data.valido){
            ...
            $(document).on('click','.pagination a',function(event){
                ...
                fetch_data('{{ route("maestroIndex") }}?page='+pagina,form);
            });
