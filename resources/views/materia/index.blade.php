...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Buscar materias.
            </div>
          </div>
          <div class="card-body">
            <h2 class="mw-80">Materias</h2>
        ...
        //limpiar
         ...
         $('#form-create').submit(function (e){
            e.preventDefault();
                try{
                    showLoading();
                    $.get('{{ route("materiaIndex") }}',$(this).serialize())
                    .done(function(data) {
                        console.log(data);
                    if(data.valido){
            ...
            $(document).on('click','.pagination a',function(event){
                ...
                fetch_data('{{ route("materiaIndex") }}?page='+pagina,form);
            });
