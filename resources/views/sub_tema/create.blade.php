...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Creación de sub tema.
            </div>
          </div>
          <div class="card-body">
            <h2 class="mw-80">Nuevo sub tema</h2>
              ...
              <div class="row clearfix loadingContent">
                ...
                <div class="col-md-4">
                  <div class="form-group form-group-default form-group-default-select2 required">
                      {{  Form::label('Tema') }}
                      {!! Form::select('tema_id', $temas, null, ['class' => 'full-width required','data-init-plugin'=>'select2']) !!}                          </div>
              </div>
              </div>
        ...
        //limpiar
         $('#form-create').submit(function (e){
            ...
            if(valido){    
                try{
                    showLoading();
                    $.post('{{ route("subTemaStore") }}',$(this).serialize())
                    .done(function(data) {
                        if(data.valido){
                            limpiar();
                            alert(data.mensaje);
