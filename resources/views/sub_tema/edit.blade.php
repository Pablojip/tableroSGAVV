...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Editar sub tema.
            </div>
          </div>
          <div class="card-body loadingContent">
            ...
            <input type="hidden" name="id" value="{{ $model->id }}"/>
              <div class="row clearfix">
                ...
                <div class="col-md-4">
                    <div class="form-group form-group-default form-group-default-select2 required">
                        {{  Form::label('Tema') }}
                        {!! Form::select('tema_id', $temas, $model->tema_id, ['class' => 'full-width required','data-init-plugin'=>'select2']) !!}                          </div>
                </div>
              </div>
              <div class="row clearfix">
                  <div class="col-md-1">
              ...
              <div class="row m-t-25">
                ...
                <div class="col-xl-2">
                    <a href="{{ route("subTemaIndex") }}" aria-label="" class="btn btn-secondary pull-right btn-lg btn-block" type="button">
                        consulta
                    </a>
                </div>
                <div class="col-xl-2">
        ...
        //limpiar
         $('#form-edit').submit(function (e){
            ...
            if(valido){    
                try{
                    showLoading();
                    $.post('{{ route("subTemaUpdate") }}',$(this).serialize())
                    .done(function(data) {
                        if(data.valido){
                            alert(data.mensaje);
                        }else{
