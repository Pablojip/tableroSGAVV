...
<div class="col-xl-12 col-lg-12 ">
        ...
        <div class="card">
          <div class="card-header ">
            <div class="card-title">Buscar sub tema.
            </div>
          </div>
          <div class="card-body loadingContent">
            <h2 class="mw-80">Sub tema</h2>
              ...
              <div class="row clearfix">
                ...
                <div class="col-md-4">
                  <div class="form-group form-group-default form-group-default-select2">
                      {{  Form::label('Temas') }}
                      {!! Form::select('tema_id', ['' => 'Seleccione...'] + $temas, null, ['class' => 'full-width','data-init-plugin'=>'select2']) !!}          
                  </div>
                </div>
              </div>
        ...
        //limpiar
         ...
         $('#form-create').submit(function (e){
            e.preventDefault();
                try{
                    showLoading();
                    $.get('{{ route("subTemaIndex") }}',$(this).serialize())
                    .done(function(data) {
                        console.log(data);
                    if(data.valido){
            ...
            $(document).on('click','.pagination a',function(event){
                ...
                fetch_data('{{ route("subTemaIndex") }}?page='+pagina,form);
            });
